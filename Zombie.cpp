...
#include "Zombie.h"
Zombie::Zombie(sf::Sprite sprite, Player player, std::string name, int life, int xpos, int ypos, int maxrigth)
{
    mEnemySprite = sprite;
    mLife = life;
    ...
    mMaxRigth = maxrigth;
    pAnimation = new NpcAnimation(Sprites::NPCZombieSprite, 32,32, 50,0,xpos, mMaxRigth );
};
Zombie::~Zombie(){};
